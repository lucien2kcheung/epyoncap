...
const translations = {
  ...
  ja: {
    ...
    hero_subtitle: '伝統的な基幹産業を支える中小企業と共に持続可能な成長を実現',
    hero_cta: '詳しく見る',

    about_title: '会社概要',
    about_text_1: '私たちは、日本の伝統的な基幹産業を支える中小企業とのパートナーシップに注力したプライベートエクイティ投資会社です。',
    about_text_2: '築き上げられた事業の価値を守り、次世代への継承・進化を支援することを使命としています。',
    about_text_3: '建設、解体、インフラサービスなどの基幹産業に関する豊富な専門知識を活かし、優れたオペレーションの知見と戦略的資本を提供し、持続可能な成長を推進します。',
    ...
    philosophy_3_text: '築き上げられた事業の伝統を尊重しながら、将来の成功に向けて前進します。',
